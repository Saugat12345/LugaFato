      ...
      child:SingleChildScrollView(
       child: Column(
        ...
        children: [
          ...
          Image.asset("assets/images/register1..webp",width: size.width*0.8,height: size.height*0.35,),
        
          const SizedBox(height: 20,),
          
          RoundedNameField(key:const ValueKey('txtName'),hintText: "FullName",
               onChanged: (value){}, 
            
          ),
          const SizedBox(height: 20,),
    
          RoundedInputField(key:const ValueKey('txtEmail'),hintText: "Email", onChanged: (value){},),
          const SizedBox(height: 20,),

          RoundedPasswordField(key:const ValueKey('txtPassword'),onChanged: (value){},),
          const SizedBox(height: 20,),
          RoundedButton(key:const ValueKey('btnSignup'),text: "SIGNUP", press: (){
            User user = User(
              name: Name.text,
              email: Email.text,
          ...
          const SizedBox(height: 20,),
          AlreadyHaveAccount(press: (){Navigator.push(context, MaterialPageRoute(builder: (context){return const LoginScreen();}));},login: false,),
          const OrDivider(),
          // Row(
          //   mainAxisAlignment: MainAxisAlignment.center,
          //   children: [
