    ...
    return BackgroundWelcome(
      child:  SingleChildScrollView(
        child: Column(
          ...
          children: [
             const Text("Welcome to Naba Nepal",style: TextStyle(color: Color.fromARGB(255, 52, 104, 181), fontWeight: FontWeight.bold,fontSize:25),
             ),
             Image.asset("assets/images/ecommerce.png",height: size.height*0.5,width: double.infinity,),
             RoundedButton(
